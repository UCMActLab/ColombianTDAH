...
public class WorkstationDetector : MonoBehaviour
{
    ...
    #region parameters
    [SerializeField] 
    private float raycastDistance; // Distancia del raycast
    [Header("Feedback Overlay Materials")]
    [SerializeField] 
    private Material overlayGreen;
    [SerializeField] 
    private Material overlayRed;
    ...
    private void DetectWorkstation()
    {
        ...
        if (Physics.Raycast(ray, out RaycastHit hit, raycastDistance, workstationLayer))
        {
            ...
            if (hitTransform != currentWorkstation)
            {
                ...
                {
                    bool canProcess = procesamientoDatabase.GetProcesamiento(
                        processableIngredient.ingredientType,
                        processor.workstationType
                    ) != null;
    ...
    {
        return procesamientoDatabase.GetProcesamiento(ingrediente, puesto) != null;
    }
